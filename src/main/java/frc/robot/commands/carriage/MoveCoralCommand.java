...
public class MoveCoralCommand extends Command {
    private final CarriageSubsystem carriageSubsystem;
    private final MotorDirection direction;
    private Dimensionless speed;
    
    public MoveCoralCommand(CarriageSubsystem carriageSubsystem, MotorDirection direction) {
        this.carriageSubsystem = carriageSubsystem;
        this.direction = direction;
        this.speed = carriageSubsystem.getDefaultSpeed();
    }

    public MoveCoralCommand(CarriageSubsystem carriageSubsystem, Dimensionless speed, MotorDirection direction) {
        this.carriageSubsystem = carriageSubsystem;
        this.direction = direction;
        this.speed = speed;
    }
