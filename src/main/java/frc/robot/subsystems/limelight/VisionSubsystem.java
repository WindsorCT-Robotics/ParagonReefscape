...
public class VisionSubsystem extends SubsystemBase {
    ...
    public record PoseOutOfBounds(Pose2d invalidPose) implements VisionError { }
    ...
    public Result<Pose2d, VisionError> estimatePosition(Degrees yaw) {
        ...
        result = camera.estimateRobotPosition();
        ...
        if (!field.isPoseWithinArea(result.pose)) {
            return new Failure<>(new PoseOutOfBounds(result.pose));
        }
