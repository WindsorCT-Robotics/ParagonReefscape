...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem, Sendable {
    ...
    private RobotConfig config = null;
        ...
        public void initSendable(SendableBuilder builder) {
            ...
            builder.addDoubleProperty("Drivetrain Current Direction", () -> getState().Pose.getRotation().getDegrees(), null);
        }
        ...
        private void configureAutobuilder() {
            // Code for pathplanning. Can be found at this link: https://pathplanner.dev/pplib-getting-started.html#install-pathplannerlib
